...
import 'package:app_jam_2024/sizin/canakkale.dart';
...
class _MainPageState extends State<MainPage> {
  ...
  List<Place> places = [
    Place(
        name: "Yerebatan S.",
        city: "İstanbul",
        image: "assets/images/sarnic.jpg"),
    Place(
        name: "Göbeklitepe",
        city: "Şanlıurfa",
    ...
    Place(
        name: "Kız Kulesi",
        city: "İstanbul",
        image: "assets/images/kizkulesi.jpg"),
    Place(
        name: "Ayasofya",
        city: "İstanbul",
    ...
    Place(
        name: "Meryem A.E",
        city: "İzmir",
        image: "assets/images/meryemana.jpg"),
    Place(
        name: "Aspendos T.",
        city: "Antalya",
        image: "assets/images/aspendos.jpg"),
    Place(
        name: "Çanakkale Ş.",
        city: "Canakkale",
        image: "assets/images/canakkale.jpg"),
  ];
            ...
            child: Column(
              ...
              children: [
                ...
                DropdownButtonFormField<String>(
                  ...
                  dropdownColor: Color(0xFF2b2831),
                ...
                ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    backgroundColor: Color(0xFFBF244d),
                ...
                switch (place.name) {
                  case "Yerebatan S.":
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => YerebatanSarnici()));
                    break;
                  case "Göbeklitepe":
                    Navigator.push(context,
                        MaterialPageRoute(builder: (context) => Gobeklitepe()));
                    break;
                  case "Galata Kulesi":
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => GalataKulesi()));
                    break;
                  case "Kız Kulesi":
                    Navigator.push(context,
                  ...
                  case "Ayasofya":
                    Navigator.push(context,
                        MaterialPageRoute(builder: (context) => Ayasofya()));
                    break;
                  case "Balıklı Göl":
                    Navigator.push(context,
                        MaterialPageRoute(builder: (context) => BalikliGol()));
                    break;
                  case "Meryem A.E":
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => MeryemAnaEvi()));
                    break;
                  case "Aspendos T.":
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => AspendonTiyatrosu()));
                    break;
                  case "Çanakkale Ş.":
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => Canakkale()));
                    break;
                }
              },
              child: Container(
